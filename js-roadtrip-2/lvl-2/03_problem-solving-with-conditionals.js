...
// population climbs above 10000, half of the sheep will be sent away to
// other regions.

// Inside our for loop, insert an if statement that:

      // Removes half of the sheep population if the number of sheep
      // rises above 10000.

      // Prints the number of sheep being removed to the console in the
      // following format:
  ...
  // You do not need to create an else statement or change any of
  // the provided code.
