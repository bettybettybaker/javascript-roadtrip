...
// Back at the Hoover Dam, the technicians have decided they
// want more control of which generators are on and off.
// So, they’ve asked you to develop a way to adjust the total
// megawatts generated upon the switch-on or switch-off of a
// single, chosen generator.

// Build a function named changePowerTotal that takes in four
// parameters:
...
// Your function should:
        ...
        // If the current generator is set to "on", then add to the
        // total power generated.
        // Or if the current generator is set to "off", then remove
        // from the total power generated.
