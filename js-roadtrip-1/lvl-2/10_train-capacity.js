...
// In creating this String, use numPassengers to find the number
// of passengers present, and (trainCapacity - numPassengers) to
// find the number of seats remaining.
